...
* There are many possibilities here:
    2. <span class="alert-blue">Lagged outcome unconfoundedness: </span> $\color{red}{\E[Y_{t=2}(0) - Y_{t=1}(0) | G=1]} = \E\Big[ \E[Y_{t=2}(0) | Y_{t=1}, G=0] - Y_{t=1}(0) \Big| G=1\Big]$
